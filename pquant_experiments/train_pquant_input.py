...
def main(config: PQConfig):
    ...
    global output_dir
    output_dir = "/eos/home-m/majorgen/particle_transformer/pquant_experiments/results/quant_input"
...
if __name__ == "__main__":
    config = dst_config()
    config.training_parameters.epochs = 15
    ...
    config.quantization_parameters.quantize_input = False
